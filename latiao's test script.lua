...
menu.toggle_loop(server, "REQUES_ENTITY vehicles", {"latiaoREQUES_ENTITYvehicles"}, "REQUES_ENTITYvehicles.", function()
...
local Pericotarget = menu.slider(dividends, "小岛目标价值", {""}, "", INT_MIN, INT_MAX, 1000, 100000, function()
end)
